"""Result caching for LLMTopTen probes"""
...
class LLMTopTenCache:
    """Cache for OWASP Top 10 probe results (shared by LLMTopTen and AgentTopTen)"""
    ...
    def clear(self) -> None:
        ...
        self.cache.clear()
        logger.info("LLMTopTen cache cleared")
