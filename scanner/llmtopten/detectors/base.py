"""Base Detector classes for LLMTopTen - Following Garak framework architecture
...
class Attempt:
    ...
    For LLMTopTen, we use a simplified version that contains:
...
class Detector(ABC):
    ...
    def __init__(self):
        ...
        self.detectorname = f"llmtopten.detectors.{self.__class__.__module__.split('.')[-1]}.{self.name}"
