"""Configuration management for LLMTopTen integration"""
...
class LLMTopTenConfig:
    """Configuration for LLMTopTen integration (OWASP LLM Top 10)"""

    def __init__(self, config_path: Optional[Path] = None):
        """
        Initialize LLMTopTen configuration

        Args:
            config_path: Optional path to config YAML file
        """
        self.config_key = "llmtopten"
