"""Result caching for Counterfit probes."""
...
class CounterfitCache:
    """Cache for Counterfit probe results."""
    ...
    def get(
        ...
        self.hits += 1
        logger.debug("Counterfit cache hit for probe %s", probe_name)
        return entry["result"]
    ...
    def set(
        ...
        if len(self.cache) >= self.max_size:
            ...
            logger.debug("Counterfit cache evicted entry for %s", oldest_key[:8])
    ...
    def clear(self) -> None:
        ...
        self.cache.clear()
        logger.info("Counterfit cache cleared")
