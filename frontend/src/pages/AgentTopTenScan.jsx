...
const AGENT_TOP_10_CATEGORIES = [
  { id: 'AA01', name: 'Agentic Misuse', icon: Bot, description: 'Unauthorized or harmful use of AI agents', color: '#8b5cf6' },
  { id: 'AA02', name: 'Identity Spoofing', icon: UserX, description: 'Agents impersonating users or other systems', color: '#ec4899' },
  { id: 'AA03', name: 'Capability Escalation', icon: Zap, description: 'Agents gaining unauthorized capabilities', color: '#f59e0b' },
  { id: 'AA04', name: 'Memory Poisoning', icon: Brain, description: 'Corrupting agent memory and context', color: '#ef4444' },
  { id: 'AA05', name: 'Tool Manipulation', icon: Unplug, description: 'Exploiting agent tool integrations', color: '#06b6d4' },
  { id: 'AA06', name: 'Permission Bypass', icon: ShieldOff, description: 'Circumventing agent security controls', color: '#f97316' },
  { id: 'AA07', name: 'Context Injection', icon: BadgeAlert, description: 'Injecting malicious context into agents', color: '#dc2626' },
  { id: 'AA08', name: 'Resource Abuse', icon: Bomb, description: 'Exhausting agent resources and quotas', color: '#14b8a6' },
  { id: 'AA09', name: 'Trust Exploitation', icon: HandMetal, description: 'Exploiting agent trust relationships', color: '#6366f1' },
  { id: 'AA10', name: 'Credential Theft', icon: KeyRound, description: 'Stealing agent credentials and secrets', color: '#a855f7' },
];

const AGENT_FRAMEWORKS = {
  langchain: ['LangChain Agent', 'ReAct Agent', 'OpenAI Functions Agent'],
...
export default function AgentTopTenScan() {
  const [scanName, setScanName] = useState('');
  const [scanDescription, setScanDescription] = useState('');
  const [agentFramework, setAgentFramework] = useState('langchain');
  ...
  const selectAllCategories = () => {
    if (selectedCategories.length === AGENT_TOP_10_CATEGORIES.length) {
      setSelectedCategories([]);
    } else {
      setSelectedCategories(AGENT_TOP_10_CATEGORIES.map(c => c.id));
    }
  };
  ...
  return (
    <div className="agenttopten-page">
      {/* Hero */}
      <div className="hero-section">
        <div className="hero-content">
          ...
          <div>
            <h1 className="hero-title">OWASP Agentic AI Top 10 Scanner</h1>
            <p className="hero-subtitle">Security testing for autonomous AI agents and multi-agent systems</p>
          </div>
        </div>
        <div className="hero-badges">
          <span className="badge badge-primary">OWASP</span>
          <span className="badge badge-secondary">Agentic AI</span>
          <span className="badge badge-accent">Multi-Agent</span>
        </div>
      </div>
      ...
      <div className="scan-grid">
        ...
        <div className="config-panel">
          <div className="panel-header">
            ...
            <p>Configure your AI agent security assessment</p>
          </div>
          ...
          <form onSubmit={handleSubmitScan} className="config-form">
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="My Agent Security Scan"
            ...
            <div className="form-section">
                  ...
                  <div className="select-wrapper">
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setAgentType(AGENT_FRAMEWORKS[e.target.value][0]);
                      }}
                ...
                <div className="form-group">
                  ...
                  <div className="select-wrapper">
                    <select
                      ...
                      className="form-select"
                    >
                      {AGENT_FRAMEWORKS[agentFramework].map(type => (
              ...
              <div className="form-group">
                <label>Agent Endpoint (Optional)</label>
                <input
                  type="url"
                  value={agentEndpoint}
                  onChange={(e) => setAgentEndpoint(e.target.value)}
                  placeholder="https://your-agent-api.com/v1"
                  className="form-input"
                />
              </div>
            </div>
            ...
            <div className="form-section">
              <div className="section-header">
                ...
                <button type="button" className="select-all-btn" onClick={selectAllCategories}>
                  {selectedCategories.length === AGENT_TOP_10_CATEGORIES.length ? 'Deselect All' : 'Select All'}
                </button>
              </div>
              <div className="categories-grid">
                {AGENT_TOP_10_CATEGORIES.map((category) => {
                ...
                <div className="vulnerabilities-list">
                  ...
                  {scanResults.findings?.length === 0 && (
                    <div className="no-vulnerabilities">
                      ...
                      <p>Your agent passed all selected security tests</p>
                    </div>
                  )}
                </div>
              )}
